...
local browser3          = "microsoft-edge-stable"
...
--awful.util.tagnames = {  "➊", "➋", "➌", "➍", "➎", "➏", "➐", "➑", "➒" }
--awful.util.tagnames = { "⠐", "⠡", "⠲", "⠵", "⠻", "⠿" }
awful.util.tagnames = { "R","E","$","T", "♐", "⌥", "ℵ", "4", "2", "0" }
...
-- Define the keybindings for resizing windows
awful.key({ modkey, altkey, modkey1 }, "Left",
    function ()
...
awful.key({ modkey, altkey, modkey1 }, "Right",
    function ()
        awful.client.incwfact(0.05)
    end,
...
awful.key({ modkey, altkey, modkey1 }, "Down",
    function ()
        awful.client.incwfact(0.05, nil, true)
    end,
    {description = "Increase master height factor", group = "Client"}
)

awful.key({ modkey, altkey, modkey1 }, "Up",
    function ()
        awful.client.incwfact(-0.05, nil, true)
    end,
